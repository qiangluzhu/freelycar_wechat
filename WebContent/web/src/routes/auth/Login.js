            ...
            <div className='panel' >
                ...
                <Flex justify='center'>
                    <div className='input-up'>
                        ...
                        <div style={{ display: 'inline-block', color: this.state.isphone ? '#5b87e5' : '#a9a9a9', verticalAlign: 'middle', paddingLeft: '.33rem', borderLeft: '1px solid #e8e8e8' }} onClick={() => { if (isphone) { this.sendCode() } }}>{this.state.allowSend ? '获取验证码' : `${this.state.wait}s后重发`}</div>
                    </div>
                </Flex>
